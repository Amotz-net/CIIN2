...
export default function RoleLayout() {
  ...
  const active = section || defaultSection(role)
    ...
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <main style={{ flex: 1, minWidth: 0 }}>
        <div className="wrap">
          ...
          {RoleView ? <RoleView profile={profile} section={active} />
                    : <div className="card"><p className="muted">No dashboard for this role.</p></div>}
        </div>
      </main>
    </div>
  )
